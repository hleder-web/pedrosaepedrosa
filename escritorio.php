<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/build/escritorio.css">
<?php
/*
...
<section class="escritorio__perfil">
   ...
   <div class="escritorio__perfil--box">
   <img src="/wp-content/themes/pedrosaepedrosa/assets/escritorio2.png" alt="" class="escritorio__perfil--image">
   </div>
   <div class="escritorio__perfil--box">
